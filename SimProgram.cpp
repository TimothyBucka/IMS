...
// ########## MACHINES ##########
machine pressing_machine(maintenance_time[0][0], 60 * SECONDS_IN_MINUTE, 1, "Pressing machine");
machine one_sided_sander(maintenance_time[1][0], 10 * SECONDS_IN_MINUTE, 10, "One sided sander");
machine aligner(maintenance_time[2][0], 10 * SECONDS_IN_MINUTE, 10, "Aligner");
machine stretcher(maintenance_time[3][0], 50 * SECONDS_IN_MINUTE, 2.5 * SECONDS_IN_MINUTE, "Stretcher");
machine double_sided_sander(maintenance_time[4][0], 10 * SECONDS_IN_MINUTE, 20, "Double sided sander");
machine oiling_machine(maintenance_time[5][0], 0, 2, "Oiling machine");
machine *machines[6];
...
machine::machine(float time, float prep_time, float piece_time, string name) : input_queue(), Facility() {
