...
#define INITIAL_MATERIAL_WAREHOUSE_WEIGHT 25000 // in kg
...
struct ProgramOptions {
    ...
    unsigned N_PRESSING = 2;
    bool press = false;
    unsigned N_ONE_SIDED_SANDER = 3;
    bool one_sided = false;
    unsigned N_ALIGNER = 2;
    bool align = false;
    unsigned N_STRETCHER = 3;
    bool stretch = false;
    unsigned N_DOUBLE_SIDED_SANDER = 2;
